...
- Query hackers by incident location
 ...
 My Contributions
I implemented all core logic in the .java file, including collision handling, resizing and rehashing, deletion, merging hacker identities, and analytical queries. This project emphasized correctness, efficiency, and careful reasoning about edge cases and data structure invariants.
